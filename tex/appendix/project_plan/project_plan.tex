...
\begin{description}[leftmargin=!,labelwidth=\widthof{\bfseries Construction Phase}]
	...
	\item [Construction Phase] In der Phase der Construction geht es an die Umsetzung der Applikation. Hierfür sind 3.5 Sprints eingerechnet. Dafür stehen die Sprints Construction-1, Construction-2, Con\-struc\-tion-3 und Construction-4 zur Verfügung.
...
\begin{center}
	\begin{longtable}{| l | p{10cm} |}
		\hline
		\textbf{Phase} & \textbf{Arbeiten}\\
		\hline
		\textit{Inception-1 } & \begin{itemize}[noitemsep]
		...
		\hline
		\textit{Elaboration-1}&	\begin{itemize}[noitemsep]
		...
		\end{itemize}\\
		\hline
		\textit{Elaboration-2}	&\begin{itemize}[noitemsep]
		...
		\end{itemize}\\
		\hline
		\textit{Construction-1} &\begin{itemize}[noitemsep]
		...
		\end{itemize}\\
		\hline
		\textit{Construction-2} &\begin{itemize}[noitemsep]
		...
		\end{itemize}\\
		\hline
		\textit{Construction-3} &\begin{itemize}[noitemsep]
			\item Oberflächen mit Xamarin.Forms umsetzen
			\item Core-Funktionalitäten mit Xamarin umsetzen
			\item Technischer Bericht weiterschreiben
		\end{itemize} \\
		\hline
		\textit{Construction-4} &\begin{itemize}[noitemsep]
			\item Oberflächen mit Xamarin.Forms umsetzen
			\item Core-Funktionalitäten mit Xamarin umsetzen
			\item Technischer Bericht weiterschreiben
		\end{itemize}\\
		\hline
		\textit{Transition-1}&\begin{itemize}[noitemsep]
...
\begin{landscape}
	...
	\includepdf[width=1\linewidth,pages=1,landscape=true,pagecommand=\subsection{Risikotabelle}\label{risiko-tabelle}
	\thispagestyle{empty},offset=40 0]{./res/projekt_risiko/TechnischeRisiken.pdf}
	\includepdf[width=1\linewidth,pages=2-,landscape=true]{./res/projekt_risiko/TechnischeRisiken.pdf}
